...
template<size_t MaxDegree, size_t Exponent>
class ElementOfFiniteField_Poly_View : public ElementOfFiniteField_Poly_Expression<ElementOfFiniteField_Poly_View<MaxDegree,Exponent>, MaxDegree, Exponent>
{
	static constexpr size_t GetCoeffCount()
	{
		return MaxDegree+1;
...
public:
	...
	constexpr ElementOfFiniteField_Poly_View( const std::array<ElementOfFiniteField<2,Exponent>, GetCoeffCount()>& Input )
		: values{ Input }
	{}
};
